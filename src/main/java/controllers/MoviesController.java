...
public class MoviesController {
    ...
    @FXML
    private ListView<Object> mainListView; // Typ Object, bo będzie wyświetlać classes.Movie lub classes.Show
    @FXML
    ...
    private TheatreService theatreService; // Potrzebujemy classes.TheatreService do cofania do wyboru teatru
    private ShowService showService; // Nowy classes.ShowService
    ...
    public void initData(Theatre theatre, MovieService movieService) {
        ...
        this.theatreService = theatreService; // Przekazujemy classes.TheatreService
        this.showService = new ShowService(); // Inicjalizacja classes.ShowService
    ...
    private void handleAction() {
        if (showingMovies) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/sceneView.fxml"));
    ...
    private void handleBack() {
        if (!showingMovies) {
            ...
            try {
                ...
                // Przekaż classes.TheatreService, aby mógł załadować teatry
