...
public class PaymentController {
    ...
    private void returnToChooseTheatreView() {
        try {
            ...
            // Jeśli ChooseTheatreController potrzebuje classes.TheatreService, możesz je przekazać
            ChooseTheatreController controller = loader.getController();
            controller.setTheatreService(new TheatreService()); // Upewnij się, że classes.TheatreService jest zainicjowany
