...
//---------------------------------------------------------------
    ...
    private void handleNext() {
        ...
        try {
//            classes.Booking newBooking = new classes.Booking(new Date(), totalAmount, currentUser.getUserId(), selectedShow.getShowId());
            Booking newBooking = new Booking(new Date(), totalAmount, 1, selectedShow.getShowId());
            newBooking.setStatus("PENDING");


            int bookingId = newBooking.getBookingId(); // Użyjemy wygenerowanego ID z obiektu classes.Booking
