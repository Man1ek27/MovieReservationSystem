...
public class TheatreViewController {
    ...
    public void addTheatre(Theatre theatre) {
        ...
        // Można dodać do jakiejś listy typu `ObservableList<classes.Theatre>` jeśli trzymasz więcej danych
    }
    ...
    private void handleAdd(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AddTheatreView.fxml"));
    ...
    private void handleManage() {
        ...
        if (selected != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ManageMoviesView.fxml"));
                Parent root = loader.load();
